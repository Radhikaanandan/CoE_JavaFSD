...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="flex justify-between items-center px-14 py-6 w-full z-50 bg-gradient-to-r from-[#6f02b8] via-[#d238f8] to-[#d78dfa]">
                <Link to="/">
                    <h2 className="text-2xl font-bold text-white">SHOEZY</h2>
                </Link>
                <div className="relative search flex items-center">
                    ...
                    <input
                        ...
                        className="pl-12 bg-white pr-10 py-3 w-[130px] rounded-full border-2 border-white focus:outline-none"
                    />
                </div>
